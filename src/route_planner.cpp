...
bool firstNodeBigger(RouteModel::Node* n1 , RouteModel::Node* n2){
...
void sortNodes( std::vector<RouteModel::Node*>& nodes){
	std::sort(nodes.begin(), nodes.end() , firstNodeBigger) ;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    // TODO: Implement your solution g_value 
    do{
...
//		distance+= i.g_value ;
//		std::cout << i.g_value * m_Model.MetricScale() <<"      "<< distance * m_Model.MetricScale() << std::endl ;
//	}
    distance = path_found.back().g_value ;

//	distance = ( (current_node->g_value) + (node->distance(*current_node)) );
